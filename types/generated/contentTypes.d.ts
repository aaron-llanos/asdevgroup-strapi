...
export interface ApiPropiedadPropiedad extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Progreso: Attribute.Enumeration<['Under Construction', 'Completed']> &
      Attribute.Required;
    URL: Attribute.String & Attribute.Required & Attribute.Unique;
    Descripcion: Attribute.Text;
    Unidad: Attribute.String;
    SliderMobile: Attribute.Media<'images'>;
    Galeria: Attribute.Media<'images', true>;
    Status: Attribute.Enumeration<['completed', 'in-process']> &
      Attribute.Required;
    Detalles: Attribute.JSON & Attribute.Required;
    Tipo: Attribute.Enumeration<
      ['Multifamily', 'Self-Storage', 'Residential', 'Hospitality']
    > &
      Attribute.Required;
    Cantidad: Attribute.String;
    PortadaySliderDesktop: Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    > &
      Attribute.Required;
    Pais: Attribute.Enumeration<['MX', 'US']> & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
